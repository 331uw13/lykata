...
#define COLOR_INDICATOR_VERY_HIGH 12
#define COLOR_INDICATOR_HIGH 13
#define COLOR_INDICATOR_MEDIUM 14
#define COLOR_INDICATOR_LOW_MEDIUM 15
#define COLOR_INDICATOR_LOW 16
#define COLOR_INDICATOR_VERY_LOW 17
